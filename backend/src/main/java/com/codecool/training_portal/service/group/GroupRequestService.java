...
public class GroupRequestService {
    ...
    public GroupJoinRequestResponseDto createJoinRequest(Long groupId) {
        ...
        Optional<UserGroupJoinRequest> duplicateRequest = requestDao.findOneByUserGroupAndApplicationUser(
    ...
    public void handleJoinRequest(
        ...
        if (request.getStatus().equals(RequestStatus.APPROVED)) {
            groupRoleService.addMember(groupId, request.getApplicationUser().getId());
